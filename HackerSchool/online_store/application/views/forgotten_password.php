...
<div id="body">
<div id="wrap">
<h2 style="text-align:center; margin-right: 15%;">Забравена парола</h2></br>
<p>На посоченият имейл ще бъде изпратен линк, чрез който ще може да си промените паролата.</p>
    <?php
